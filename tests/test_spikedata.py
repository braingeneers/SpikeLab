...
class SpikeDataTest(unittest.TestCase):
    ...
    def test_get_traces(self):
        ...
        attrs = [NeuronAttrs(channel=1), NeuronAttrs(channel=2), NeuronAttrs(channel=0)]
        sd = SpikeData(
            trains,
        ...
        self.assertIsNotNone(sd.neuron_attributes[0].waveform)
        self.assertIsNotNone(sd.neuron_attributes[1].waveform)
        self.assertIsNone(sd.neuron_attributes[2].waveform)
