...
class AgentFactory:
    ...
    def create_researcher(llm_config: dict):
        return AssistantAgent(
            name="Researcher",
            system_message=AgentFactory._read_prompt(
                "agent_swarm/agents/prompts/researcher.md"
            ),
    ...
    def create_engineer(llm_config: dict):
        return AssistantAgent(
            name="Engineer",
            system_message=AgentFactory._read_prompt(
                "agent_swarm/agents/prompts/engineer.md"
            ),
            llm_config=llm_config,
            is_termination_msg=AgentFactory._is_termination_msg,
        )
    ...
    def create_validator(llm_config: dict):
        return AssistantAgent(
            name="Validator",
            system_message=AgentFactory._read_prompt(
                "agent_swarm/agents/prompts/validator.md"
            ),
            llm_config=llm_config,
            is_termination_msg=AgentFactory._is_termination_msg,
        )
    ...
    def create_coordinator(llm_config: dict):
        return AssistantAgent(
            name="Coordinator",
            system_message=AgentFactory._read_prompt(
                "agent_swarm/agents/prompts/coordinator.md"
            ),
            llm_config=llm_config,
            is_termination_msg=AgentFactory._is_termination_msg,
        )
