...
def register_swarm_tools(agent: ConversableAgent, executor_agent: ConversableAgent, tool_map: Dict[str, Callable], tool_definitions: List[Dict[str, Any]]):
    """
    ...
    for tool_def in tool_definitions:
        ...
        if func:
            ...
            agent.register_for_llm(name=name, description=tool_def["function"]["description"])(wrapper)
            ...
            print(f"Warning: Tool function implementation for '{name}' not found in tool_map.")
